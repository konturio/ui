...
const Chart24 = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <path d="M7 12.5V17" stroke="currentColor" strokeWidth={1.3} />
    <path d="M12 7L12 17" stroke="currentColor" strokeWidth={1.3} />
    <path d="M17 11L17 17" stroke="currentColor" strokeWidth={1.3} />
