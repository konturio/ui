...
const AnalyticsPanelIcon = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg width="18" height="22" viewBox="0 0 18 22" fill="none" {...props}>
    ...
    />
    <path d="M13 16H5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M13 12H5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M7 8H6H5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path
      d="M11 1V7H17"
      stroke="currentColor"
      fill="currentColor"
