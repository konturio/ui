...
export const BivariateMatrixCellConnector = forwardRef(({ type, style }: BivariateMatrixCellConnectorProps, ref) => {
  ...
  return (
    <div className={type === 'horizontal' ? styles.horConnector : styles.vertConnector} style={style}>
