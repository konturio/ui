...
export const VisTimeline = forwardRef(VisTimelineComponent) as <T extends TimelineEntry>(
  props: TimelineProps<T> & { ref?: React.ForwardedRef<TimelineImperativeApi | null> },
) => ReturnType<typeof VisTimelineComponent>;
