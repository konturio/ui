...
const InfoErrorOutline16 = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} viewBox="0 0 16 16" fill="none" {...props}>
    ...
    />
    <path d="M8.00004 5.00004L8.00004 8.62523" stroke="currentColor" strokeLinejoin="round" />
    <path d="M8.00004 10L8.00004 11" stroke="currentColor" strokeLinejoin="round" />
  </svg>
);
